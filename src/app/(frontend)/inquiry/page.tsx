export default function Inquiry() {
  return (
    <div className="flex px-14 gap-12 bg-[#FF6731] text-white py-24  items-start">
      ...
      <div className="w-[27.5%]">
        ...
        <div className="pt-8">
          ...
          <p className="py-3 text-justify">
            ...
            union rep...or a real estate agent. It's our job to get you the best possible price for
            your home, or to see to it that you get the best possible deal on the property you want
            to buy.
          </p>
          <div className="w-[30%] bg-white h-[1px] mt-10"></div>
        </div>
